...
export default function Jobs({ data }) {
  ...
  const columns = [
    ...
    {
      name: "StaffCommunicate1",
      selector: (row) => row.staffCommunicate1,
      sortable: true,
    },
    {
      name: "StaffCommunicate2",
      selector: (row) => row.staffCommunicate2,
      sortable: true,
    },
    {
      name: "StaffCommunicate3",
      selector: (row) => row.staffCommunicate3,
      sortable: true,
    },
    {
      name: "satisfiedRatting",
      selector: (row) => row.satisfiedRatting,
      sortable: true,
    },
    {
      name: "Comment",
